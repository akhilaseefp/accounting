     ...
     <div class="row">
          ...
          <div class="col-md-3">
            ...
            <select class="form-control" name="status" id="status" required>
              ...
              <option selected="0" value="">Please Select</option>
              <option value="1">Paid Orders</option>
              <option value="2">Paid - Not Delivered</option>
          ...
          <div class="col-md-2">
              <input class="btn btn-success" type="submit" name="btngo" id="btngo" value="Go" formaction="<?php echo base_url(); ?>index.php/Esalescontrol/eCommercePaydetails">
          </div>
     </div>
     <div class="row">
          <div class="col-md-8">
