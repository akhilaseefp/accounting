   ...
   <section class="content">
     ...
     <div class="row">
          ...
          <div class="col-md-1" style="margin-top:25px;">
            <input class="btn btn-success" type="submit" name="btngo" id="btngo" value="Go" formaction="<?php echo base_url(); ?>index.php/Esalescontrol/ecomproductionreport">
          </div>
     </div>
     <div class="row">
          <div class="col-md-5">
...
<td align="center">  <?php if ($key->item_shipped==1) { ?> 
                    ...
                    <td align="center" style="display:none;">  <?php if ($key->item_dispatch==1) { ?> 
