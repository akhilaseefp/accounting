...
// var ctr=1;
		...
		try{
			...
			// 		success: function(result) {
				...
				var taxpercentage=0;
						...
						if (a == 1) {
							$('#unitprice').val(purchaserate.toFixed(2));
							$('#amount1').val((purchaserate * Qty).toFixed(2));
							$('#taxamount1').val(taxamount.toFixed(2));
							$('#hsn1').val(hsn);
 ...
 var checkbox=document.getElementById('chk_tax');
						...
						var newTr = '<tr><td>' + rowCount +
							...
							'" class="form-control" name=""></td><td style="'+style+'"><input type="text" id="' + tax +
							'" class="form-control taxd"  name=""></td><td style="'+style+'"><input type="text" id="' + taxamount +
							'" class="form-control taxamountd"  name=""></td><td style="'+style+'"><input type="text" id="' + totalamount +
							'" class="form-control totalamountd"  name=""></td><td class="ctr" style="display:none;">' + ctr +
							'</td> <td style="display:none;"><a href="" class="delete" >X</a></td><td style="display:none;"><input type="text" id="' + oldqty +
...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Purchase Update</li>
		</ol>
	</section>
...
<a href="#" class="next" id="next">Next &raquo;</a></div>
				<div class="row">
					<div class="col-md-4">
						<label>Voucher no :</label>
							...
							<input type="text" name="voucherno" class="form-control" required autocomplete="off" id="voucherno" value="">
											</div>
					<div class="col-md-4">
						<label>Supplier :</label>
						
						<input type="text" class="form-control" list="supplier1" autocomplete="off" id="supplier" name="supplier" value="">
				...
				<div class="row">
					<div class="col-md-4">
						<label>Vendor invoice no :</label>
							...
							<input type="text" value="" name="vendorinvoiceno" class="form-control" id="vendor" autocomplete="off">
					</div>
					<div class="col-md-4">
						<label>Invoice date :</label>
						<input type="date" name="invoicedate" class="form-control" id="invoicedate" value=""> 
					...
					<div class="col-md-4">
						...
						<select class="form-control" name="branch" id="branch">
							<?php
										...
										{
											if($master->result()[0]->branchid==$gp->branchid)
										{ ?>
									<option value="<?php echo $gp->branchid; ?>" selected><?php echo $gp->branchname; ?></option>
									<?php 
										} 
										else{?>
										<option value="<?php echo $gp->branchid; ?>"><?php echo $gp->branchname; ?></option> ?></option>
										<?php } ?>
									<?php } ?>
					...
					<TABLE id="dataTable1" border="1" class="table table-striped table-hover">
						<thead>
							<tr>
								...
								<th class="d-none d-xl-block" style="">TAX %</th>
                ...
                ?>
					 ...
					 <div class="col-md-4">
					<input class="btn btn-info" type="submit" name="btnclear" value="add row" id="addrow"></div>
            ...
            <div id="imageref"></div>
				...
				<hr>
					...
					<fieldset>
						...
						<input type="text" value="" class="form-control" name="totalstockamount" id="totalstockamount" style="">

						<div class="row">
							<div class="col-md-6">
								<label>Total Qty :</label>
								<input type="text" value="" class="form-control" name="totalqty" id="totalqty">
							</div>
							<div class="col-md-6">
								<label>Total Amount :</label>
								<input type="text" class="form-control" value="" name="totalamount" id="totalamount">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<input type="text" value="0" class="form-control" value="" name="additionalcost" id="additionalcost">
								<input type="hidden" value="0.00" id="oldac" name="">
							</div>
							<div class="col-md-6">
								<label>Tax Amount :</label>
								<input type="text" class="form-control" value="0.00" name="taxamount" id="taxamount">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<input type="text"  value="0.00" class="form-control" name="billdiscount" id="billdiscount">
								<input type="hidden" value="0.00" id="oldbd" name="">
							</div>
							<div class="col-md-6">
								<label>Grand Total :</label>
								<input type="text" class="form-control" value="0.00" name="grandtotal" id="grandtotal">
					...
					<fieldset style="font-size: 14px;background: #f0f0f0; font-style: bolder">Payment
						<div class="row form-group">
							...
							<div class="col-md-4 form-group">
								...
								<select class="form-control" id="cash" name="cash" >
									...
									<option value="<?php echo $cledger->ledgerid; ?>" selected><?php echo $cledger->ledgername; ?></option>
								...
								<select class="form-control" id="bank" name="bank" >
									<?php
										foreach ($BankLedgers->result() as $bledger) {
																 ...
																 ?>
										<option value="<?php echo $bledger->ledgerid; ?>" selected><?php echo $bledger->ledgername; ?></option>
						...
						<div class="row form-group">
							<div class="col-md-4 form-group">
								...
								<input type="text" name="balance" id="balance" value="0.00" class="form-control" autocomplete="off">
								<input type="hidden" value="0.00" id="oldbl" name="">
							</div>

							<div class="col-md-4 form-group">
								<label style="color: black">Paid Cash :</label>
								<input type="text"  value="0.00" name="paidcash" id="paidcash" class="form-control" required autocomplete="off">
								<input type="hidden" value="0.00" id="oldpc" name="oldpc">
							</div>

							<div class="col-md-4 form-group">
								<label style="color: black">Paid Bank :</label>
								<input type="text" value="0.00" name="paidbank" id="paidbank" class="form-control" required autocomplete="off">
				...
				<div class="row margin" style="text-align: center">
					...
					<!-- <a href="<?php echo base_url(); ?>index.php/Purchasecontrol/deletemaster?a=<?php echo $vo;?>"> -->
                  ...
                  // $.noConflict();
						try {
							$.ajax({
								type: "POST",
								// dataType:"json",
								url: "<?php echo base_url() ?>index.php/Purchasecontrol/loadpurchaseinvoice",
								data: {
									'voucherno' : a
								},
											...
											document.getElementById("btndelete").disabled = false;
												...
												if (master['master'].length==0) {alert("no such invoice exists "); ctr=1;
...
<script type="text/javascript"> var max=0;
   ...
   if(loadinvno!=0){
	...
	var a =document.getElementById("dataTable1").rows[i].cells[11].innerHTML;
		rowcalculation(a);
		calculation();
	});
  ...
  $(this).closest("tr").find('.qty').val(qty);
	...
	function rowcalculation(a) {
		if (a == 1) { 
			...
			var purchaserate = $('#unitprice1').val();
			...
			$('#amount1').val((QTY * purchaserate).toFixed(2));
			$('#taxamount1').val(taxamount.toFixed(2));
...
var count=0;
										...
										for (var i = 1; i < table.rows.length-1; i++) {
											...
											if (i == 1) {
												...
												newunitprice = $('#newunitprice1').val();
												qty = $('#qty1').val();
												hsncode= $('#hsn1').val();
											 	batch =  $('#batch').val();
											} else {
												unitprice = $('#unitprice' + no).val();
												newunitprice = $('#newunitprice' + no).val();
												qty = $('#qty' + no).val();
												hsncode= $('#hsn'+no).val();
											    batch =  $('#batch' + no).val();
											}
											...
											if (1 == 2) {
														...
														data: {
															...
															'batch': batch,
															'amount': amount,
															'purchasemasterid':data
														},
														success: function (data) {var result1 = JSON.stringify(data);
...
// 															 	
  ...
  // //                                                                       ctr=1; 
		...
		// // 													$('#vendor').val('');
		// // 													var d = new Date();
		// // 													$('#invoicedate').val(d.toLocaleString());
		// // 													$('#payment').val('0.00');
		// // 													$('#narration').val('');
		// // 													$('#company').val('');
		// // 													$('#totalqty').val('0.00');
		...
		// // 													$('#taxamount').val('0.00');
		// // 													$('#billdiscount').val('0.00');
		// // 													$('#grandtotal').val('0.00');
		// // 													$('#oldbalance').val('0.00');
		// // 													$('#totalstockamount').val('0.00');
		// // 													$('#paidcash').val('0.00');
		// // 													$('#paidbank').val('0.00');
		// // 													$('#balance').val('0.00');
		// // 													$('#dataTable  tr').remove();
		...
		// // 	productcode + '"></td><td style="display: none;"> <input type="number" value="1" class="form-control" autocomplete="off" id="' + hsn + '" name="productcode"></td><td><input type="text" id="' + size + '" class="form-control size" list="size" name="" ></td><td> <input type="number" value="1" class="form-control qty" autocomplete="off" id="' + qty + '" name="productcode"></td><td><input type="text" id="' + batch + '" class="form-control" list="bat" name=""></td><td><input type="text" id="' + unitprice + '" class="form-control unitprice" name=""></td><td><input type="text" id="' + amount + '" class="form-control" name=""></td><td><input type="text" id="' + taxamount + '" class="form-control"  name=""></td><td><input type="text" id="' + totalamount + '" class="form-control"  name=""></td><td class="ctr" style="display:none">' + ctr +'</td> <td><a href="" class="delete" >X</a></td> </tr>';
		// // $('#dataTable1').append(newTr);
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#btnupdate').on('click', function() {
			...
			try {
				$.ajax({
					type: "POST",
					// dataType:"json",
					url: "<?php echo base_url() ?>index.php/Purchasecontrol/editdetailes",
					data: {
						'voucherno': voucherno,
						'supplier': supplier,
						'order': order,
					...
					success: function(data) {
						...
						for (var i = 1; i < table.rows.length; i++) 
						{
							...
							if (productname == null) {
								...
								$.ajax({
									type: "POST",
									url: "<?php echo base_url() ?>index.php/Purchasecontrol/edittable",
									data: {
										'voucherno': voucherno,
										'invoicedate': date,
										'productname': productname,
									...
									success: function(data) {
										...
										// document.getElementById("barcodemrp").style.visibility = "hidden";
									},
        ...
        alert(request.responseText);
						...
						$.ajax({
							type: "POST",
							url: "<?php echo base_url() ?>index.php/Purchasecontrol/updPurchaseInvoice_DyaBookInsertion",
							data: {
								'voucherno': voucherno,
								'date': date,
								'totalamount': totalamount-oldta,
								'tax': tax1-oldtx,
								'paidcash': paidcash-oldpc,
								'paidbank': paidbank-oldpb,
								'paymentmode': payment,
								'discount': discount-oldbd,
								'balance': balance-oldbl,
								'cash': cash,
								'bank': bank,
								'supplier': supplier
							},
							...
							success: function(data) {
								...
								//PurchaseInvoice_AccountInsertion_Start
								// discount = oldbd - discount;
								// tax1 = oldtx - tax1; 
        //                         paidcash = oldpc - paidcash;
        //                         paidbank = oldpb - paidbank;
								// $.ajax({
								// 	type: "POST",
								// 	url: "<?php echo base_url() ?>index.php/Purchasecontrol/updPurchaseInvoice_AccountInsertion",
								// 	data: {
								// 		'PurchaseDiscount': discount-oldbd,
								// 		'TotalPurchasedStockAmount': totalamount-oldta,
								// 		'TotalTaxAmt': tax1-oldtx,
								// 		'qty': qty,
								// 		'unitprice': unitprice,
								// 		'mrp': mrp,
								// 		'balance': balance-oldbl,
								...
								// 	success: function(data) { alert("purchase Updated successfully");
								// 		location.reload();
								// 		// //Autogenerate_VoucherNo_start
		...
		$('#btndelete').on('click', function() {
			...
			try {
				...
				$.ajax({
					...
					type: "POST",
					// dataType:"json",
					url: "<?php echo base_url() ?>index.php/Purchasecontrol/deletedetailes",
					data: {
						'voucherno': voucherno,
						'supplier': supplier,
						'order': order,
					...
					success: function(data) {
						...
						for (var i = 1; i < table.rows.length - 1; i++) 
						{
							...
							else
							{
								$.ajax({
									type: "POST",
									url: "<?php echo base_url() ?>index.php/Purchasecontrol/delete_purchasedetailes",
									data: {
										'voucherno': voucherno,
										'invoicedate': date,
										'productname': productname,
									...
									success: function(data) {
										...
										// document.getElementById("barcode").style.visibility = "hidden";
										// document
										// 	.getElementById("barcode").style.display = "none";
										// document.getElementById(
										// 	"barcodemrp").style.visibility = "hidden";
						...
						$.ajax({
							type: "POST",
							url: "<?php echo base_url() ?>index.php/Purchasecontrol/Purchasedelete_DyaBookInsertion",
							data: {
								'voucherno': voucherno,
								'date': date,
								'totalamount': totalamount,
							...
							success: function(data) {
								...
								$.ajax({
									type: "POST",
									url: "<?php echo base_url() ?>index.php/Purchasecontrol/deletePurchaseInvoice_AccountInsertion",
									data: {
										'PurchaseDiscount': discount,
										'TotalPurchasedStockAmount': TotalPurchasedStockAmount,
										'TotalTaxAmt': tax1,
...
<svg id='barcode' style="display: none;"></svg>
	...
	mywindow.document.write('<table border=1px solid black;>');

	mywindow.document.write('<tr><td style="padding:5px;" colspan="9"><b>Billed to </b></td></tr>');

	mywindow.document.write('<tr><td style="padding:5px;" colspan="9">Name:'+supplier+'<br>address:'+ship_address+'<br>State:'+state+'<br>Contact: '+number1+'</td></tr>');
 ...
 mywindow.document.write('<tr><td style="text-align:center">'+n+'</td><td style="text-align:center">'+product+'</td><td style="text-align:center">'+qty+'</td><td style="text-align:center">'+unitprice+'</td><td style="text-align:center">'+size+'</td><td style="text-align:center">'+igs+'</td><td style="text-align:center">'+cgs+'</td><td style="text-align:center">'+sgs+'</td><td style="text-align:left">'+amount+'</td></tr>');
n++;
}
										} 
								mywindow.document.write('<tr><td colspan="4" style="font-size:30px;"><b>Total</b></td><td></td><td style="font-size:30px;" colspan="4"><b>'+totalamount+'</b></td></tr>');

	mywindow.document.write('<tr><td  colspan="5" rowspan="5">CASH PAYMENT :'+paidcash+'<br>BANK PAYMENT :'+paidbank+'<br>BALANCE TO PAY :'+balance+'</td><td colspan="4">CGST 	                     - Rs: '+cgst+'/-  </td></tr><tr><td colspan="4">SGST                   - Rs:  '+sgst+'/- </td></tr><tr><td colspan="4">IGST 	                   - Rs : '+igst+'/- </td></tr><tr><td colspan="4">Discount 	                   - Rs : '+discount+'/- </td></tr><tr><td colspan="4">Grand Total	 	                -  '+grandtotal+'/- </td></tr><tr></tr>');
