		...
		<div class="box box-default">
			<div class="box-body">
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
						<button style="background-color: green; color: #ffff!important; padding: 7px;margin-top: 22px;"><a style="color: white;" href="<?php echo base_url();?>Customer" target="_blank" ><i class="fa fa-user-plus" aria-hidden="true"></i> &nbsp;Add Customer</a></button>
					</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
				...
				<div class="row col-md-12 form-group margin txn-bottom-form" style="text-align: center;">
					...
					<div class="col-md-4">
						...
						<label for="child" style="margin-right: 20px; ">SHIPPING FROM</label>
							...
							<input type="radio" name="radioName" value="1" /> INR 
							<input type="radio"   name="radioName" value="3" /> UAE 
							<input type="radio" checked="" name="radioName" value="2" /> USA 
						</form>
...
<option value="N/A">N/A</option>
				...
				<input type="text" class="form-control" list="countrylist" required autocomplete="off"  name="country" id="country">
							<!-- <option value="0"  data-balance="0.00">Select Customer</option> -->
