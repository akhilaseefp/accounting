...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">eCommerce Order AED</li>
      </ol>
    </section>
   <section class="content">
     ...
     <div class="row">
          ...
          <div class="col-md-1" style="margin-top:25px;">
            <input class="btn btn-success" type="submit" name="btngo" id="btngo" value="Go" formaction="<?php echo base_url(); ?>index.php/Esalescontrol/eCommerceaed">
          </div>
     </div>
     <div class="row">
          <div class="col-md-5">
