...
<div class="content-wrapper">
   <section class="content-header">
      <h1>
      eCommerce Report By Paid Not Delivered
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>index.php/Onlinecontrol"><i class="fa fa-dashboard"></i>Home</a></li>
        <!-- <li><a href="#">Forms</a></li> -->
        <li class="active">eCommerce Report By Paid Not Delivered</li>
      </ol>
    </section>
   <section class="content">
     ...
     <div class="row">
          ...
          <div class="col-md-1" style="margin-top:25px;">
            <input class="btn btn-success" type="submit" name="btngo" id="btngo" value="Go" formaction="<?php echo base_url(); ?>index.php/Esalescontrol/eCommercedetailsbyPaidNotDelivered">
          </div>
     </div>
     <div class="row">
          <div class="col-md-5">
