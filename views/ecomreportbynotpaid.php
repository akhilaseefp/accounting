...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Report By Not Paid</li>
      </ol>
    </section>
   <section class="content">
     ...
     <div class="row">
          ...
          <div class="col-md-3">
              <input class="btn btn-success" type="submit" name="btngo" id="btngo" value="Go" formaction="<?php echo base_url(); ?>index.php/Esalescontrol/ecomreportbynotpaid">
          </div>
     </div>
     <div class="row">
          <div class="col-md-8">
