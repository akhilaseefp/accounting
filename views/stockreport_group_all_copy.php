          ...
          <div class="row">
            <div class="col-md-3">
              <table border="1" class="table table-hover">
                <thead>
                 <tr>
                   <th style="text-align: center;" colspan="3" >Below 2000</th>
               ...
               <tbody id= "myTable">
                <?php 
                foreach($below2t->result() as $k) :?>
                  <tr>
                    <td><?php echo $k->productid; ?></td>
                    <td><?php echo $k->currentstock; ?></td>
                    <td><?php echo $k->currentstock; ?></td>
                  </tr>
                <?php endforeach; ?>
            ...
            <div class="col-md-3">
              <table border="1" class="table table-hover">
                <thead>
                 <tr>
                    <th style="text-align: center;" colspan="3" > 2000 - 2500</th>
                 </tr>

               </thead>
               <tbody id= "myTable">

              <?php foreach($b2t25->result() as $k) :?>
                  <tr>
                    <td><?php echo $k->productid; ?></td>
                    <td><?php echo $k->currentstock; ?></td>
                    <td><?php echo $k->currentstock; ?></td>
            ...
            <div class="col-md-3">
              <table border="1" class="table table-hover">
                <thead>
                 <tr>
                    <th style="text-align: center;" colspan="3" > 2500 - 3000</th>
                 </tr>
            ...
            <div class="col-md-3">
              <table border="1" class="table table-hover">
                <thead>
                 <tr>
                    <th style="text-align: center;" colspan="3" > 3000 - 3500</th>
            ...
            <div class="col-md-3">
              <table border="1" class="table table-hover">
                <thead>
                 <tr>
                    <th style="text-align: center;" colspan="3" > 3500 - 4000</th>
            ...
            <div class="col-md-3">
              <table border="1" class="table table-hover">
                <thead>
                 <tr>
                    <th style="text-align: center;" colspan="3" > 4000 - 4500</th>
             ...
             <div class="col-md-3">
              <table border="1" class="table table-hover">
                <thead>
                 <tr>
                    <th style="text-align: center;" colspan="3" > 4500 - 5000</th>
            ...
            <div class="col-md-3">
              <table border="1" class="table table-hover">
                <thead>
                 <tr>
                    <th style="text-align: center;" colspan="3" > Above 5000</th>
