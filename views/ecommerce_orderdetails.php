...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">eCommerce Order</li>
      </ol>
    </section>
     ...
     <div class="row">
          ...
          <div class="col-md-3">
            ...
            <select class="form-control" name="status" id="status" required>
                ...
                <?php if ($status == '0') {
                 echo '<option selected value="0">Processing</option>
                  <option value="1">Item Ready</option>
                  <option value="2">Shipped From DXB</option>
                  <option value="3">Reached PMNA</option>
                  <option value="4">Dispatched to customer</option>
                  <option value="5">Delivered</option>
                  <option value="6">Return</option>';
                } elseif ($status == 1) {
             echo '<option  value="0">Processing</option>
                  <option selected value="1">Item Ready</option>
                  <option value="2">Shipped From DXB</option>
                  <option value="3">Reached PMNA</option>
                  <option value="4">Dispatched to customer</option>
                  <option value="5">Delivered</option>
             ...
             echo '<option  value="0">Processing</option>
                  <option  value="1">Item Ready</option>
                  <option selected value="2">Shipped From DXB</option>
                  <option value="3">Reached PMNA</option>
                  <option value="4">Dispatched to customer</option>
                  <option value="5">Delivered</option>
                  <option value="6">Return</option>';
                ...
                echo  '<option  value="0">Processing</option>
                 <option  value="1">Item Ready</option>
                 <option  value="2">Shipped From DXB</option>
                 <option selected value="3">Reached PMNA</option>
                 <option value="4">Dispatched to customer</option>
                 <option value="5">Delivered</option>
                 <option value="6">Return</option>';
                }elseif ($status == 4) {
               echo   '<option  value="0">Processing</option>
                 ...
                 <option  value="2">Shipped From DXB</option>
                 <option value="3">Reached PMNA</option>
                 <option selected value="4">Dispatched to customer</option>
                 <option value="5">Delivered</option>
                 <option value="6">Return</option>';
                }elseif ($status == 5) {
                echo  '<option  value="0">Processing</option>
                 ...
                 <option value="3">Reached PMNA</option>
                 <option value="4">Dispatched to customer</option>
                 <option selected value="5">Delivered</option>
                 <option value="6">Return</option>';
                }elseif ($status == 6) {
               echo  '<option  value="0">Processing</option>
                 <option  value="1">Item Ready</option>
                 ...
                 <option value="4">Dispatched to customer</option>
                 <option  value="5">Delivered</option>
                 <option selected value="6">Return</option>';
                }else{
          ...
          <div class="col-md-2">
              <input class="btn btn-success" type="submit" name="btngo" id="btngo" value="Go" formaction="<?php echo base_url(); ?>index.php/Esalescontrol/eCommercedetails">
          </div>
     </div>
     <div class="row">
          <div class="col-md-8">
