     ...
     <div class="box box-default">
        <div class="box-body">
           <div class="row margin" style="text-align: right;">
                  <a href="<?php echo base_url();?>index.php/Onlinecontrol/salesestimate"><button class="btn btn-success">NEW</button></a>
                </div> 
   ...
   <div class="row margin">
       <div class="table-responsive" style="overflow-x: scroll;">
                  ...
                  foreach ($master->result() as $key) {
                    ...
                    <td><a href="<?php echo base_url();?>index.php/Salescontrol/savestimate?voucher=<?php echo $key->invoiceno;?>"><button class="btn btn-success">Approve</button></a></td>
                  </tr>
                      <?php }?>
                      </tbody>
                 </table>
