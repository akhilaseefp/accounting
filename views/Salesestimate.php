                       ...
                       // alert(salesdate);
						...
						try {
							...
							$.ajax({
								...
								type: "POST",
								// dataType:"json",
								url: "<?php echo base_url() ?>index.php/Salescontrol/insert_salesestimatemaster",
								data: {
									'invoiceno': invoiceno,
									'customer': customer,
								...
								success: function (data) {
									...
									for (var i = 1; i < table.rows.length; i++) {
										...
										$.ajax({
											...
											type: "POST",
											url: "<?php echo base_url() ?>index.php/Salescontrol/insert_salesestimatedetails",
											data: {
												'invoiceno': invoiceno,
												'salesdate': salesdate,
     ...
     <!--  <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="total" id="billtotal"></td>
          </tr>
          <tr>
            <td colspan="5">TAX</td>
            <td class="total" id="billtax"></td>
          </tr>
          <tr>
            <td colspan="5" class="grand total">GRAND TOTAL</td>
            <td class="grand total" id="billgrand"></td>
          </tr>
        </tbody>
      </table> -->
